import brain
import random #in built library
...
class Player:
    def __init__(self):
        # Bird
        self.x, self.y = 50, 200 # starting position of the bird
        self.rect = pygame.Rect(self.x, self.y, 20, 20) # size of the bird
        self.color = random.randint(100, 255), random.randint(100, 255), random.randint(100, 255) # color of the bird
        self.vel = 0 # velocity of the bird
        self.flap = False # flap of the bird
        self.alive = True # alive status of the bird
        self.lifespan = 0 # lifespan of the bird
    ...
    def ground_collision(self, ground):
        return pygame.Rect.colliderect(self.rect, ground) # pygame function to check collision
